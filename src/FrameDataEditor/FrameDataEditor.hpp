...
namespace SpiralOfFate
{
	...
	private:
		...
		void _cleanThisCharacterProperties();
	...
	public:
		...
		tgui::FileDialog::Ptr openFileDialog(tgui::Gui &gui, const std::string &title = "Open file", const std::filesystem::path &basePath = game->settings.lastPath, bool overWriteWarning = false, bool mustExist = true);
		tgui::FileDialog::Ptr saveFileDialog(tgui::Gui &gui, const std::string &title = "Save file", const std::filesystem::path &basePath = game->settings.lastPath);
